...
<html lang="en">
 ...
 <body>
 	<div class="container">
		<header class="b-dark-gray no-print mcenter"><?php echo $this->elements->getHeader(); ?></header>
		...
		<article id="content" class="main">
			<?php echo $this->tag->form(array('concours/create', 'method' => 'post', 'style' => 'width:100%')); ?>
